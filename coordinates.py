...
# ADVENTURE OFFSETS
RIGHT_ARROW = Pixel(937, 210)
LEFT_ARROW = Pixel(735, 210)
ITOPOD = Pixel(372, 224)
ITOPOD_PERKS = Pixel(451, 226)
ITOPOD_START = Pixel(625, 199)
ITOPOD_END = Pixel(625, 235)
ITOPOD_ENTER = Pixel(629, 297)
ITOPOD_AUTO = Pixel(706, 208)
HEALTH = Pixel(735, 415)
...
# ROW 1 ABILITIES
ABILITY_IDLE_MODE = Pixel(370, 103)
ABILITY_REGULAR_ATTACK = Pixel(472, 109)
...
# ROW 3 ABILITIES
ABILITY_PARALYZE_GAZE = Pixel(321 + 5, 186)
ABILITY_HYPER_REGEN = Pixel(426 + 5, 186)
ABILITY_BEAST_MODE = Pixel(531 + 5, 186)
...
# MENU OFFSETS
MENU_OFFSET_X = 233
MENU_FIGHT = Pixel(MENU_OFFSET_X, 50)
MENU_PIT = Pixel(MENU_OFFSET_X, 76)
MENU_ADVENTURE = Pixel(MENU_OFFSET_X, 104)
MENU_INVENTORY = Pixel(MENU_OFFSET_X, 130)
MENU_AUGMENTATIONS = Pixel(MENU_OFFSET_X, 159)
...
# PIXEL CHECKS
IS_BOSS_CROWN = ColorPixel(735, 281, 'F7EF29')
IS_ENEMY_ALIVE = ColorPixel(*HEALTH, ['D93030', 'EB3434', 'DB3131', 'DA3030',
                                      'E73333'])  # If you reduce the enemy healthbar to 1px, the color changes for some reason
...
IS_IDLE = ColorPixel(315, 87, 'FFEB04')  # top right yellow pixel
...
FCCY_ZERO = 24 # FEATURE_COLOR_CHECK_Y_ZERO
FCCY_OFFSET = 27 # FEATURE_COLOR_CHECK_Y_OFFSET
COLOR_LOCKED = ['97A8B6', '96A7B7']
COLOR_ADV_TRAINING_LOCKED = ColorPixel(FCCX, FCCY_ZERO+FCCY_OFFSET*6, COLOR_LOCKED)
